...
| Artifact mutation after evaluation | Invalid comparison | Immutable snapshot/hash/signature | All three signed (Ed25519, PEM key ring); artifacts and reports verified at activation, snapshots verified on load |
